...
describe("the match offered for watching", () => {
  ...
  it("replays a tie played under non-default fuel settings", () => {
    ...
    const lean = { enabled: true, spawnEveryTicks: 45, maxOnField: 8, amount: 40, radius: 14 };
  ...
  it("carries the settings rather than assuming them", () => {
    ...
    const lean = { enabled: true, spawnEveryTicks: 30, maxOnField: 10, amount: 60, radius: 16 };
